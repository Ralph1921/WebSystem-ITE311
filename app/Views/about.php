...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="<?= site_url('/about') ?>">About</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="container mt-4">
        ...
        <p>This is the about page for the ITE311 project. Here you can find information about the project, its purpose, and goals.</p>
